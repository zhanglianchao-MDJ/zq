...
//            List<AuthorityRuleEntity> rules = sentinelApiClient.fetchAuthorityRulesOfMachine(app, ip, port);
            ...
            if(rules!=null&&!rules.isEmpty()) {
                for (AuthorityRuleEntity entity : rules) {
                    ...
                    authorityRule.setResource(entity.getResourceL());
                    authorityRule.setLimitApp(entity.getLimitAppL());
                    authorityRule.setStrategy(entity.getStrategyL());
                    entity.setRule(authorityRule);
                }
            }
